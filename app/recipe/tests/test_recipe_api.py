...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(user=self.user, title='Sample recipe', link='https://example.com/recipe.pdf')
        payload = { 'title': 'New recipe title', 'link': 'https://example.com/new-recipe.pdf', 'time_minutes': 25, 'price': Decimal('4.00'), }
        url = detail_url(recipe.id)
